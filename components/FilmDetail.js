...
import { StyleSheet, View, Text, ActivityIndicator, Image, Button, Touchable, Share, Platform} from 'react-native'
...
class FilmDetail extends React.Component{
        ...
        if(params.film != undefined && Platform.OS === 'ios'){
          return{
            headerRight: <TouchableOpacity
                            styles={styles.share_toucable_headerrightbutton}
    ...
    componentDidUpdate(){
        console.log("componetdiUpdate : "+this.props.favoritesFilm)
    }
...
const styles = StyleSheet.create({
  ...
  share_toucable_headerrightbutton:{
    marginRight: 8,
  }
  })
